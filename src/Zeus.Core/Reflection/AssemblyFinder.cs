...
namespace Zeus.Core.Reflection
{
    public class AssemblyFinder : IAssemblyFinder
    {
        private readonly IApplicationModuleContainer _moduleContainer;

        private readonly Lazy<IReadOnlyList<Assembly>> _assemblies;

        public AssemblyFinder(IApplicationModuleContainer moduleContainer)
        {
